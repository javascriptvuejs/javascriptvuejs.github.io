...
이제 + 버튼을 클릭하면 TodoInput 컴포넌트에서 App 컴포넌트로 신호(이벤트)를 보내 App 컴포넌트 addTodo() 메서드를 실행합니다.
...
![todobeforeclearall](/images/todobeforeclearall.PNG)

### 모든 할 일 삭제 후

![todoafterclearall](/images/todoafterclearall.PNG)
